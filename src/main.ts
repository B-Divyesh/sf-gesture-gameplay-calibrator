...
function homePage(): string {
  return `${header()}<main id="main">
    <section class="hero"><div class="hero-copy"><p class="eyebrow">A field notebook for webcam moves</p><h1>Will your gesture hold up in a real room?</h1><p class="lede">Teach the browser a pose, replay it under real conditions, and leave with a portable threshold profile—before you wire it into a game.</p><a class="primary-button button-link" href="#workbench">Calibrate a move</a><p class="hero-proof"><span>●</span> Camera frames never leave your device</p></div><figure class="hero-art"><img src="${heroUrl}" width="768" height="512" alt="An open graph-paper notebook with an abstract jointed paper figure and red checkpoint circles" fetchpriority="high" decoding="async" /><figcaption>Observe → record → stress-test</figcaption></figure></section>
